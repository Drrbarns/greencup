...
export default function ProductSeoEditor({
  ...
  const liveUrl = `greencup4u.com/product/${slug || '…'}`;
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        <div className="rounded-xl border border-gray-200 overflow-hidden bg-white">
          ...
          <div className="px-4 py-3">
            <p className="text-[11px] uppercase text-gray-400">greencup4u.com</p>
      ...
      <div>
        ...
        <div className="flex flex-wrap items-center gap-3 mt-2 text-sm">
          ...
          <button
            type="button"
            onClick={async () => {
              await navigator.clipboard.writeText(`https://greencup4u.com/product/${slug}`);
              setCopied(true);
