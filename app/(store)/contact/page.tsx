...
function ContactForm() {
  ...
  const contactEmail = getSetting('contact_email') || 'hello@greencup4u.com';
  const contactAddress = getSetting('contact_address') || 'GCB Bank, White House, Spintex Road, Accra, Ghana';
