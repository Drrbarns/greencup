...
| Public URL | `https://greencup4u.com` |
...
6. Point DNS for `greencup4u.com` at the VPS when the app is healthy.
7. Set Moolre callback URL to `https://greencup4u.com/api/payment/moolre/callback`.
